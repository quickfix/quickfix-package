Gem::Specification.new do |s|
  ...
  s.files       = s.files       = Dir.glob("lib/*.rb") + Dir.glob("ext/quickfix/*.*") + Dir.glob("ext/quickfix/double-conversion/*.*") + Dir.glob("ext/quickfix/swig/*.*") + Dir.glob("spec/FIX*.xml") + Dir.glob("test/*") + Dir.glob("Rakefile")
